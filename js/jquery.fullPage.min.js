...
!(function(e, n) {
	...
	(e.fn.fullpage = function(l) {
		...
		function ye(n, t, o) {
			...
			var r = n.find(D);
			r.length && (0 !== e(b).index(y) || (0 === e(b).index(y) && 0 !== r.index()))
				? et(r, "internal")
				: t.eq(0).addClass(p);
		}
		function be(n, t) {
		...
		function xe(n, t) {
			"undefined" != typeof l.anchors[t] && n.hasClass(p) && Mn(l.anchors[t], t),
				l.menu && l.css3 && e(l.menu).closest(r).length && e(l.menu).appendTo(dt);
		}
		function Ce() {
		...
		function ke() {
			...
			for (var t = 0; t < e(y).length; t++) {
				...
				"undefined" != typeof a &&
					"" !== a &&
					(i +=
						'<div class="' + O + " " + l.navigationPosition + '">' + a + "</div>"),
					(i += "</li>"),
					n.find("ul").append(i);
			}
		...
		function Fe(n, t) {
			...
			return t < l.normalScrollElementTouchThreshold &&
				...
				? !0
				: t == l.normalScrollElementTouchThreshold ? !1 : Fe(o, ++t);
		}
		function Ve(e) {
		...
		function wn(e) {
			Ct && (e.pageY < Yt && kt.m.up ? se() : e.pageY > Yt && kt.m.down && ce()),
				(Yt = e.pageY);
		}
		function Sn(n, t, o) {
			var i = n.closest(y),
		...
		function Rn(e) {
			if (!e.hasClass("fp-noscroll")) {
				...
				var r =
					yt - parseInt(i.css("padding-bottom")) - parseInt(i.css("padding-top"));
				n > r
					? a.length
						? t.update(e, r)
		...
		function Hn(e) {
			e.hasClass(W) ||
				e
					.addClass(W)
					.wrapInner('<div class="' + T + '" style="height:' + Bn(e) + 'px;" />');
		}
		function Bn(e) {
			var n = yt;
			...
			l.anchors.length &&
				...
				(e
					? ("undefined" != typeof t && (i = t),
						...
						(ht = n),
						Un(i + "/" + n))
					: "undefined" != typeof e ? ((ht = n), Un(t)) : Un(t)),
				jn();
		}
		function Un(e) {
		...
		function Kn() {
			...
			var a =
				"onwheel" in t.createElement("div")
					? "wheel"
					: t.onmousewheel !== i ? "mousewheel" : "DOMMouseScroll";
			"DOMMouseScroll" == a
					...
					void e.each(l.anchors, function(n, t) {
						...
						(i.length || o.length) &&
							...
							i.length &&
								st(
									"error",
									'"' + t + '" is is being used by another element `id` property'
								),
							o.length &&
								st(
									"error",
									'"' + t + '" is is being used by another element `name` property'
								));
					}));
		}
		function st(e, n) {
