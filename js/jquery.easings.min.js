				...
				function a(e, t, i) {
					...
					return null == e
						...
						: ((e = a.floor ? ~~e : parseFloat(e)),
							isNaN(e)
								? t.def
								: a.mod ? (e + a.mod) % a.mod : 0 > e ? 0 : e > a.max ? a.max : e);
				}
				function s(e) {
					var a = u(),
						s = (a._rgba = []);
													...
													: m(d, function(t, i) {
															...
															m(i.props, function(e, t) {
																...
																c[s] &&
																	...
																	((c[s][3] = 1), i.from && (c._rgba = i.from(c[s])));
														}),
												this)
											: i
							);
					...
					m(o, function(e, i) {
						(t.cssHooks[i] = {
							...
							(t.fx.step[i] = function(e) {
								e.colorInit ||
									((e.start = u(e.elem, i)), (e.end = u(e.end)), (e.colorInit = !0)),
			...
			(function() {
				...
				function a(t, i) {
					...
					for (a in i)
						(s = i[a]),
							t[a] !== s &&
								(n[a] || ((e.fx.step[a] || !isNaN(parseFloat(s))) && (r[a] = s)));
					return r;
				}
				...
				function s(t, i, a, s) {
					return (
						...
						(t.duration = e.fx.off
							...
							: "number" == typeof a
								? a
								: a in e.fx.speeds ? e.fx.speeds[a] : e.fx.speeds._default),
			...
			(function() {
				...
				e.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function(e, i) {
					...
					e.extend(t, {
						...
						Elastic: function(e) {
							return 0 === e || 1 === e? e: -Math.pow(2, 8 * (e - 1)) *
