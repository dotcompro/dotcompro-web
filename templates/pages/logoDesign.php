<div class="section" id="logo-section">
	<div class="portfolio-gallery">
		<div class="header">
			<div class="wrapper">
				<div class="title-left">
					<h1 alt="corporate design/ brand identity">Logo design</h1>
				</div>
		...
		<div class="p-body logoDesign-body">
			<section class="logo-gallery">
				<ul>
					<li><img src="img/icon-1.png" alt=""></li>
					<li><img src="img/icon-2.png" alt=""></li>
					<li><img src="img/newImages/post_stamp.png" alt=""></li>
					<li><img src="img/icon-3.png" alt=""></li>
					<li><img src="img/Webdevelopment-icon.jpg" alt=""></li>
			...
			<section class="info-text-block">
				<div class="wrapper">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore velit quam recusandae perspiciatis deserunt eum.</p>
